...
namespace NICE_Helper
{
    ...
    {       
        ...
        //public static void Log(string Source, Helper.LogLevel Level, Exception ex, string Message = "")
        //{
        //    try
        //    {
        //        using (FileStream strm = new FileStream(_outFile, FileMode.Append))
        ...
        //                str.Append(DateTime.Now.ToLongTimeString() + " " + DateTime.Now.ToString("dd/MM/yyyy") + " ");
        //                str.Append(Level.ToString());
        //                str.Append(": [Exception Target] - ");
        //                str.Append(ex.TargetSite);
        //                wrtr.WriteLine(str.ToString());
        //            }
        //        }
        //        if (Message != "")
        ...
        //public static void Log(Exception ex, string Source, Helper.LogLevel Level)
        //{
        //    try
        //    {
        //        using (FileStream strm = new FileStream(_outFile, FileMode.Append))
